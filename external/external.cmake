  ...
  endforeach()
	...
	if (NOT ${DepName}_HEADER_ONLY)
		...
		if (${DepName}_LIB_NAME)
			...
			if(MSVC)
				set(DEP_LIBS ${DEP_LIBS} ${${DepName}_LIB_NAME} optimized ${${DepName}_LIB_NAME}.lib debug ${lib_name}${${DepName}_DEBUG_POSTFIX}.lib PARENT_SCOPE)
			else()
				set(DEP_LIBS ${DEP_LIBS} ${${DepName}_LIB_NAME} optimized lib${${DepName}_LIB_NAME}.a debug lib${lib_name}${${DepName}_DEBUG_POSTFIX}.a PARENT_SCOPE)
			endif()
		endif()
	endif()
